...
vump/0.2.0 darwin-x64 node-v8.10.0
$ vump --help [COMMAND]
USAGE
  $ vump COMMAND
...
...
_See code: [src/commands/list.ts](https://github.com/tomodian/vump/blob/v0.2.0/src/commands/list.ts)_
...
_See code: [src/commands/next.ts](https://github.com/tomodian/vump/blob/v0.2.0/src/commands/next.ts)_
...
_See code: [src/commands/to.ts](https://github.com/tomodian/vump/blob/v0.2.0/src/commands/to.ts)_
<!-- commandsstop -->
